...
-- Blaster
WEAPON_BLASTER_DAMAGE_MIN                        = 10
WEAPON_BLASTER_DAMAGE_MAX                        = 23
WEAPON_BLASTER_SPEED                             = 700
WEAPON_BLASTER_BOUNCES                           = 5

-- Hyperblaster
WEAPON_HYPERBLASTER_DAMAGE_MIN                   = 15
WEAPON_HYPERBLASTER_DAMAGE_MAX                   = 16
WEAPON_HYPERBLASTER_SPEED                        = 900
WEAPON_HYPERBLASTER_BOUNCES                      = 3

-- Shotgun
WEAPON_SHOTGUN_DAMAGE_MIN                        = 8
WEAPON_SHOTGUN_DAMAGE_MAX                        = 9
WEAPON_SHOTGUN_DAMAGE_ENERGY_MIN                 = 7
WEAPON_SHOTGUN_DAMAGE_ENERGY_MAX                 = 11
WEAPON_SHOTGUN_KICK                              = 8
WEAPON_SHOTGUN_PELLET_COUNT_DEATHMATCH           = 8
WEAPON_SHOTGUN_PELLET_COUNT_NORMAL               = 8

-- Super Shotgun
WEAPON_SUPERSHOTGUN_DAMAGE_MIN                   = 10
WEAPON_SUPERSHOTGUN_DAMAGE_MAX                   = 11
WEAPON_SUPERSHOTGUN_DAMAGE_ENERGY_MIN            = 14
WEAPON_SUPERSHOTGUN_DAMAGE_ENERGY_MAX            = 16
WEAPON_SUPERSHOTGUN_KICK                         = 17
WEAPON_SUPERSHOTGUN_PELLET_COUNT                 = 17

-- Machinegun
WEAPON_MACHINEGUN_DAMAGE_MIN                     = 10
WEAPON_MACHINEGUN_DAMAGE_MAX                     = 11
WEAPON_MACHINEGUN_KICK                           = 2
WEAPON_MACHINEGUN_TRACER_DAMAGE                  = 12
WEAPON_MACHINEGUN_TRACER_COOLDOWN_MS             = 500

-- Chaingun
WEAPON_CHAINGUN_DAMAGE_MIN                       = 5
WEAPON_CHAINGUN_DAMAGE_MAX                       = 6
WEAPON_CHAINGUN_KICK                             = 3
WEAPON_CHAINGUN_TRACER_DAMAGE                    = 8
WEAPON_CHAINGUN_TRACER_COOLDOWN_MS               = 300

-- Grenade
WEAPON_GRENADE_DAMAGE                            = 200
WEAPON_GRENADE_RADIUS_OFFSET                     = 100.0

-- Grenade Launcher
WEAPON_GRENADELAUNCHER_DAMAGE_NORMAL             = 100
WEAPON_GRENADELAUNCHER_DAMAGE_NAPALM             = 95
WEAPON_GRENADELAUNCHER_RADIUS_NORMAL             = 100.0
WEAPON_GRENADELAUNCHER_RADIUS_NAPALM             = 115.0
WEAPON_GRENADELAUNCHER_SPEED                     = 600

-- Rocket
WEAPON_ROCKET_DAMAGE_MIN                         = 99
WEAPON_ROCKET_DAMAGE_MAX                         = 101
WEAPON_ROCKET_SPEED                              = 1050
WEAPON_ROCKET_RADIUS                             = 115

-- Railgun
WEAPON_RAILGUN_DAMAGE                            = 100
WEAPON_RAILGUN_DAMAGE_HORDE                      = 125
WEAPON_RAILGUN_KICK                              = 285

-- 20mm Cannon
WEAPON_CANNON20MM_DAMAGE                         = 40
...
-- Plasma Beam
WEAPON_PLASMABEAM_DAMAGE                         = 16
WEAPON_PLASMABEAM_DAMAGE_SINGLEPLAYER            = 18
